...
const ptBR = {
  ...
  leadQualify: {
    ...
    step5Low: "[Perfeito], começando com o pé direito. Qual o tamanho da [equipe atual]?",
    step5High: "Uau, volume alto! Isso já é [operação de peso]. Qual o tamanho da [equipe atual] hoje?",
    step6: "[Show]. Qual o seu melhor [e-mail corporativo]?",
    step6Tight: "Equipe enxuta pra esse volume! É [exatamente aí] que a Tlin ajuda. Qual o seu melhor [e-mail corporativo]?",
...
const enUS: TranslationDictionary = {
  ...
  leadQualify: {
    ...
    step5Low: "[Perfect], starting off strong. What is your [current team size]?",
    step5High: "Wow, that's a big volume! Sounds like a [serious operation]. What is your [current team size] today?",
    step6: "[Perfect]. What is your best [corporate email]?",
    step6Tight: "Small team for that volume! That's [exactly where] Tlin helps. What is your best [corporate email]?",
...
const esES: TranslationDictionary = {
  ...
  leadQualify: {
    ...
    step5Low: "[Perfecto], empezando con el pie derecho. ¿Cuál es el tamaño del [equipo actual]?",
    step5High: "¡Vaya, volumen alto! Eso ya es una [operación grande]. ¿Cuál es el tamaño del [equipo actual] hoy?",
    step6: "[Excelente]. ¿Cuál es tu mejor [correo corporativo]?",
    step6Tight: "¡Equipo pequeño para ese volumen! Es [justo ahí] donde la Tlin ayuda. ¿Cuál es tu mejor [correo corporativo]?",

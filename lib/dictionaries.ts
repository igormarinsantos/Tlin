...
const ptBR = {
  ...
  leadQualify: {
    ...
    step7: "Perfeito! Quando podemos te [mostrar a Tlin] funcionando? Escolha um dia:",
    step8: "[Show]! Agora escolha um [horário disponível]:",
    step9: "Então, deixa eu ver se [eu entendi tudo] certinho:",
...
const enUS: TranslationDictionary = {
  ...
  leadQualify: {
    ...
    step7: "Perfect! When can we [show you Tlin] in action? Choose a day:",
    step8: "[Great]! Now pick an [available time]:",
    step9: "Let me check if [I got everything] right:",
...
const esES: TranslationDictionary = {
  ...
  leadQualify: {
    ...
    step7: "¡Perfecto! ¿Cuándo podemos [mostrarte la Tlin] funcionando? Elige un día:",
    step8: "¡[Genial]! Ahora elige un [horario disponible]:",
    step9: "Entonces, déjame ver si [entendí todo] bien:",

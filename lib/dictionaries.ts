...
const ptBR = {
  ...
  leadQualify: {
    ...
    step6: "[Show], {name}! Qual o seu melhor [e-mail corporativo]?",
    step6Tight: "Equipe enxuta pra esse volume! É [exatamente aí] que a Tlin ajuda a {name}. Qual o seu melhor [e-mail corporativo]?",
    step6Scale: "Equipe grande! A Tlin ajuda a {name} a tirar [o máximo] desse time. Qual o seu melhor [e-mail corporativo]?",
...
const enUS: TranslationDictionary = {
  ...
  leadQualify: {
    ...
    step5: "[Got it], {name}. What is your [current team size]?",
    step5Low: "[Perfect], {name}! Starting off strong. What is your [current team size]?",
    step5High: "Wow, that's a big volume! Sounds like a [serious operation] for {name}. What is your [current team size] today?",
    step6: "[Perfect], {name}! What is your best [corporate email]?",
    step6Tight: "Small team for that volume! That's [exactly where] Tlin helps {name}. What is your best [corporate email]?",
    step6Scale: "Big team! Tlin helps {name} get [the most] out of it. What is your best [corporate email]?",
    step7: "Perfect, {name}! When can we [show you Tlin] in action? Choose a day:",
    step8: "[Great]! Now pick an [available time] for {name}:",
    step9: "Alright, {name}, let me check if [I got everything] right:",
    step9High: "With that volume, {name} is clearly operating [at a different level]. Let me confirm your details before we book your demo:",
    step10: "[Request successfully sent]! Our team of experts is already analyzing [{name}]'s profile and will contact you shortly via [WhatsApp].",
    start: "Start",
...
const esES: TranslationDictionary = {
  ...
  leadQualify: {
    ...
    step5: "[Entendido], {name}. ¿Cuál es el tamaño del [equipo actual]?",
    step5Low: "[Perfecto], {name}! Empezando con el pie derecho. ¿Cuál es el tamaño del [equipo actual]?",
    step5High: "¡Vaya, volumen alto! Eso ya es una [operación grande] para {name}. ¿Cuál es el tamaño del [equipo actual] hoy?",
    step6: "[Excelente], {name}! ¿Cuál es tu mejor [correo corporativo]?",
    step6Tight: "¡Equipo pequeño para ese volumen! Es [justo ahí] donde la Tlin ayuda a {name}. ¿Cuál es tu mejor [correo corporativo]?",
    step6Scale: "¡Equipo grande! La Tlin ayuda a {name} a sacar [el máximo] de ese equipo. ¿Cuál es tu mejor [correo corporativo]?",
    step7: "¡Perfecto, {name}! ¿Cuándo podemos [mostrarte la Tlin] funcionando? Elige un día:",
    step8: "¡[Genial]! Ahora elige un [horario disponible] para {name}:",
    step9: "Entonces, {name}, déjame ver si [entendí todo] bien:",
    step9High: "Con ese volumen, se nota que {name} ya opera [en otro nivel]. Déjame confirmar tus datos antes de agendar tu demo:",
    step10: "¡[Solicitud enviada con éxito]! Nuestro equipo de especialistas ya está analizando el perfil de [{name}] y te contactará pronto por [WhatsApp].",
    start: "Iniciar",

...
export const esES: TranslationDictionary = {
  ...
  faq: {
    ...
    a6: "Solo haz clic en cualquier botón 'Ver Demo' o habla directamente con Igor aquí en el chat. Nuestro equipo agendará una llamada estratégica para mapear tu embudo y mostrar el potencial de escala.",
  ...
  footer: {
    ...
    segmentsLink1: "Clínicas",
    segmentsLink2: "Escuelas",
    segmentsLink3: "Asesorías",
    segmentsLink4: "Abogacía",
  ...
  liaPopup: {
    ...
    demoMode: "Igor está en modo demostración.",
    errorWarning: "Igor puede cometer errores. Verifica las respuestas.",
    placeholder: "Pregúntale a Igor...",
    close: "Cerrar",
    newChat: "Nuevo chat",
    talkToLia: "Habla con Igor",
    welcomeGreeting: "Hola, ¿cómo estás?",
    welcomePitch: "Entendamos cómo Tlin puede organizar tu operación comercial y preparar una demostración para tu negocio.",
    followUpPrompt: "¿Convertimos tu WhatsApp en una operación comercial que vende 24/7?",
  ...
  leadQualify: {
    ...
    step2Plan: "¡[Genial], {name}! Vi que estás mirando el plan [{plan}]. Pásame tu mejor [WhatsApp] que yo mismo te escribo por ahí.",
    ...
    step7High: "¡De acuerdo, {name}! Con ese volumen, cuanto antes hablemos, mejor. Vamos a agendar [15 minutos] para mostrarte la Tlin funcionando de verdad. Elige un día:",
    step8: "¡[Buena elección]! Para {day}, ahora solo falta el horario que funcione mejor para {name}:",
    ...
    thinking2: "Entendiendo cómo llamarte, {name}...",
    thinking3: "Validando el WhatsApp que enviaste...",
    thinking4: "Confirmando el contacto de {name}...",
    thinking5: "Analizando un volumen de {answer}...",
    thinking6: "Dimensionando una operación con {answer}...",
    thinking7: "Organizando tu contacto para la demostración...",
    thinking8: "Revisando los horarios disponibles para {answer}...",
    thinking9: "Preparando tu reserva para {answer}...",
    thinking10: "Finalizando el registro...",
    start: "Iniciar",

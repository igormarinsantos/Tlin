...
export const ptSegmentCampaigns: SegmentCampaigns = {
  clinicas: {
    ...
    socialProof: "+790 médicos entrevistados usam IA",
  ...
  escolas: {
    ...
    socialProof: "+1.200 professores entrevistados usam IA",
  ...
  assessorias: {
    ...
    socialProof: "+23 mil profissionais entrevistados usam IA",
...
export const enSegmentCampaigns: SegmentCampaigns = {
  clinicas: {
    ...
    socialProof: "+790 surveyed physicians use AI",
  ...
  escolas: {
    ...
    socialProof: "+1,200 surveyed teachers use AI",
  ...
  assessorias: {
    ...
    socialProof: "+23K surveyed professionals use AI",
  ...
  advocacia: {
    ...
    socialProof: "+155 surveyed attorneys report AI use in their firms",
...
export const esSegmentCampaigns: SegmentCampaigns = {
  clinicas: {
    ...
    socialProof: "+790 médicos encuestados usan IA",
  ...
  escolas: {
    ...
    socialProof: "+1.200 docentes encuestados usan IA",
  ...
  assessorias: {
    ...
    socialProof: "+23 mil profesionales encuestados usan IA",
  ...
  advocacia: {
    ...
    socialProof: "+155 abogados encuestados usan IA en su estudio",

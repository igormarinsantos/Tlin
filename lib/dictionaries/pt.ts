...
export const ptBR = {
  ...
  faq: {
    ...
    a6: "Basta clicar em qualquer botão 'Ver Demo' ou falar diretamente com o Igor aqui no chat. Nosso time agendará uma call estratégica para mapear seu funil e mostrar o potencial de escala.",
  ...
  footer: {
    ...
    segmentsLink2: "Escolas",
    segmentsLink3: "Assessorias",
    segmentsLink4: "Advocacia",
  ...
  liaPopup: {
    ...
    demoMode: "O Igor está em modo demonstração.",
    errorWarning: "O Igor pode cometer erros. Considere verificar informações importantes.",
    placeholder: "Pergunte para o Igor...",
    close: "Fechar",
    newChat: "Novo chat",
  ...
  agentObjectionAnimation: {
    ...
    msg2: "Entendo! Com esse plano você recupera o investimento já nos primeiros atendimentos. Faz sentido pra você?",
    msg3: "Faz sim, muito! Como eu começo?",
    msg4: "Show! Só preciso confirmar seus dados e te chamo no WhatsApp com os próximos passos. 🚀"
  },
  followUpAnimation: {
    msg1: "Vou dar uma olhada com calma e te chamo, valeu!",
    gap1: "1 hora depois",
    msg2: "Só reforçando: já separei tudo certinho, qualquer dúvida me chama por aqui!",
    gap2: "3 dias depois",
    msg3: "Oi! Passando pra saber se ainda faz sentido a gente continuar essa conversa 🙂",
    gap3: "5 dias depois",
    msg4: "Ainda dá tempo! Consigo te ajudar rapidinho, é só me chamar.",
    msg5: "Nossa, tinha esquecido completamente! Ainda tenho interesse sim.",
    msg6: "Que bom! Vou te passar os próximos passos agora mesmo. 🚀"
  },
  leadQualify: {
    ...
    step7High: "Combinado, {name}! Com esse volume, quanto antes a gente conversar, melhor. Bora marcar [15 minutos] pra eu te mostrar a Tlin funcionando de verdade. Escolha um dia:",
    step8: "[Boa escolha]! Pra {day}, agora só falta o horário que funciona melhor pra {name}:",
    ...
    thinking2: "Entendendo como te chamar, {name}...",
    thinking3: "Validando o WhatsApp que você enviou...",
    thinking4: "Confirmando o contato de {name}...",
    thinking5: "Analisando o volume de {answer}...",
    thinking6: "Dimensionando uma operação com {answer}...",
    thinking7: "Organizando seu contato para a demonstração...",
    thinking8: "Conferindo os horários disponíveis em {answer}...",
    thinking9: "Preparando sua reserva para {answer}...",
    thinking10: "Finalizando o cadastro...",
    start: "Iniciar",

...
export const enUS: TranslationDictionary = {
  ...
  roi: {
    ...
    disclaimer: "Simulation based on an average ticket of R$500 and an estimated {rate} conversion rate with Tlin. Actual results vary by operation.",
  ...
  faq: {
    ...
    a6: "Just click any 'Watch Demo' button or speak directly with Igor here in the chat. Our team will schedule a strategic call to map your funnel and show the scaling potential.",
  ...
  footer: {
    ...
    segmentsTitle: "Industries",
    segmentsLink1: "Clinics",
    segmentsLink2: "Schools",
    segmentsLink3: "Advisory firms",
    segmentsLink4: "Law firms",
  ...
  liaPopup: {
    ...
    demoMode: "Igor is in demonstration mode.",
    errorWarning: "Igor can make mistakes. Verify the answers.",
    placeholder: "Ask Igor...",
    close: "Close",
    newChat: "New chat",
  ...
  leadQualify: {
    ...
    step7High: "Alright, {name}! With that volume, the sooner we talk the better. Let's book [15 minutes] so I can show you Tlin actually working. Choose a day:",
    step8: "[Great choice]! For {day}, now just the time that works best for {name}:",
    ...
    thinking2: "Learning how to address you, {name}...",
    thinking3: "Validating the WhatsApp number you sent...",
    thinking4: "Confirming {name}'s contact details...",
    thinking5: "Analyzing a volume of {answer}...",
    thinking6: "Sizing an operation with {answer}...",
    thinking7: "Organizing your contact for the demo...",
    thinking8: "Checking available times on {answer}...",
    thinking9: "Preparing your booking for {answer}...",
    thinking10: "Wrapping up your signup...",
    start: "Start",
    ...
    sendingRequest: "Sending your request. Please wait for confirmation.",
    bookingUncertain: "The booking response did not arrive. To avoid another booking, check with our team before trying again.",
    bookingSupport: "Check with our team",
    bookingSupportMessage: "Hello! Please check whether my demo was booked. Reference:",
    retryAvailability: "Check availability again",

...
export const enUS: TranslationDictionary = {
  ...
  campaigns: {
    ...
    recuperacaoDeLeads: {
      ...
      painBody: "44% of reps give up after the 1st. The lead didn't say no, they just stopped replying. Without someone to re-engage at the right moment, that sale never comes back."
    },
    crmComIa: {

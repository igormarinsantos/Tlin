          ...
          >
              ...
              {messages.length === 0 ? (
                <>
                  <div className="flex flex-col items-center mt-6 mb-6">
                    ...
                    <h2 className="text-xl font-bold text-[#0c0d0d] mb-1 tracking-tight text-center">{lia.greeting}</h2>
                    <p className="text-sm text-zinc-600 font-medium text-center">{lia.subtitle}</p>
                  </div>

                  <div className="flex flex-col mb-5">
                    <button onClick={() => setInputValue(lia.q1)} className="flex items-start gap-4 py-3 border-b border-zinc-100/80 hover:bg-zinc-50/50 transition-colors text-left group">
                      ...
                      <span className="text-sm text-zinc-700 font-medium leading-snug">{lia.q1}</span>
                    </button>
                    <button onClick={() => setInputValue(lia.q2)} className="flex items-start gap-4 py-3 border-b border-zinc-100/80 hover:bg-zinc-50/50 transition-colors text-left group">
                      <svg className="w-4 h-4 text-zinc-400 mt-0.5 group-hover:text-[#B597FF] transition-colors shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17l9.2-9.2M17 17V7H7"/></svg>
                      <span className="text-sm text-zinc-700 font-medium leading-snug">{lia.q2}</span>
                    </button>
                    <button onClick={openWhatsApp} className="flex items-center gap-4 py-3 px-4 bg-green-50/50 rounded-xl mt-4 hover:bg-green-100 transition-colors text-left group border border-green-100 shadow-sm">
                      ...
                      <span className="text-sm text-green-800 font-bold leading-snug">{lia.whatsapp}</span>
                    </button>
                  </div>
                </>
              ) : (
            ...
            <div className="px-4 pb-4 bg-white">
               ...
               <p className="text-center text-[10px] text-zinc-400 mt-3 font-medium">
                 {messages.length > 0 ? lia.demoNote : lia.errorNote}
               </p>
            </div>
          </motion.div>
        )}

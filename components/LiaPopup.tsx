              ...
              {messages.length === 0 ? (
                <>
                  ...
                  <div className="flex flex-col mb-5">
                    <button onClick={() => setInputValue("Quero saber mais sobre os planos")} className="flex items-start gap-4 py-3 border-b border-zinc-100/80 hover:bg-zinc-50/50 transition-colors text-left group">
                    ...
                    <button onClick={() => setInputValue("Como funciona a automação?")} className="flex items-start gap-4 py-3 border-b border-zinc-100/80 hover:bg-zinc-50/50 transition-colors text-left group">
                      <svg className="w-4 h-4 text-zinc-400 mt-0.5 group-hover:text-[#B597FF] transition-colors shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17l9.2-9.2M17 17V7H7"/></svg>

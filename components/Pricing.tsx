...
function MarketComparison() {
  ...
  const HeaderIcon = ({ column }: { column: "agent" | "crm" | "human" }) => {
    ...
    return <Icon className="h-5 w-5 shrink-0 text-[#0c0d0d]" strokeWidth={1.8} aria-hidden="true" />;
  };

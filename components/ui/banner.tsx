...
export function Banner({
  ...
  return (
    <div
      ...
      {...props}
      className={cn(
        "relative flex flex-row items-center justify-center px-4 text-center text-sm font-medium",
        variant === "normal" && "bg-[#B597FF]/10 text-[#0c0d0d]",
    ...
    >
      ...
      {id ? (
        <button
          ...
          className={cn(
            "absolute cursor-pointer end-2 md:end-6 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-zinc-600 transition-colors",
            props.className
          )}
        >

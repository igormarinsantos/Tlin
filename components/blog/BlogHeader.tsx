  ...
  return (
    <header className="relative z-20 px-5 py-6 md:px-8">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-6">
        ...
        <a href="https://tlin.ia.br/#planos" className="shrink-0 whitespace-nowrap rounded-full bg-[#0c0d0d] px-4 py-2.5 text-xs font-bold text-white transition hover:bg-gradient-to-r hover:from-[#B597FF] hover:to-[#38E3FF] hover:text-[#0c0d0d] md:text-sm">
          Começar agora
        </a>
      </div>
    </header>

...
| 06-09-01 | 09 | 5 | BLOG-06 | T-06-03, T-06-07, T-06-08 | Função agrega conteúdo em booked/qualified/won, mantém não atribuído e não expõe PII | database | `npm test -- tests/funnel-database.test.ts`<br>`git diff --check` | ❌ planned / ✅ base | ⬜ pending |
| 06-09-02 | 09 | 5 | BLOG-06 | T-06-03, T-06-08 | Relatório autenticado renderiza agregados sem misturar clique com resultado comercial | route/UI contract | `npm test -- tests/funnel-report-route.test.ts tests/funnel-database.test.ts`<br>`npm run typecheck` | ❌ planned / ✅ base | ⬜ pending |
| 06-10-01 | 10 | 5 | BLOG-04, BLOG-05 | T-06-04 | Workflow exige verdade, aprovação, autoria/ativo real e operação Git/PR | governance contract | `npm test -- tests/editorial/governance.test.ts`<br>`git diff --check` | ❌ planned | ⬜ pending |
| 06-10-02 | 10 | 5 | BLOG-04, BLOG-05 | T-06-04 | Publicação sem evidência/revisor/approval falha; draft continua privado | contract | `npm test -- tests/editorial/governance.test.ts tests/editorial/content-contract.test.ts`<br>`npm run typecheck` | ❌ planned | ⬜ pending |
| 06-11-01 | 11 | 6 | BLOG-03, BLOG-05 | T-06-09, T-06-10, T-06-11 | llms.txt filtra publicados após as mutações finais de hubs/queries e não promete ranking/inclusão/citação | integration/contract | `npm test -- tests/editorial/discovery-outputs.test.ts`<br>`npm run typecheck` | ❌ planned | ⬜ pending |
| 06-11-02 | 11 | 6 | BLOG-03, BLOG-05 | T-06-09, T-06-10, T-06-11 | llms-full mantém conjunto canônico sem markup executável ou conteúdo privado | integration/contract | `npm test -- tests/editorial/discovery-outputs.test.ts tests/editorial/content-contract.test.ts`<br>`git diff --check` | ❌ planned | ⬜ pending |
| 06-12-01 | 12 | 7 | BLOG-01, BLOG-02, BLOG-03, BLOG-04, BLOG-05, BLOG-06, BLOG-07 | T-06-03, T-06-10, T-06-11 | Gate completo registra resultados reais e não chama serviço comercial | phase gate | `npm test -- tests/editorial`<br>`npm run check`<br>`git diff --check` | ❌ planned | ⬜ pending |
...
- [ ] `tests/editorial/migration-parity.test.ts` — 06-01-02 e expansões 06-03..06-06, contrato BLOG-07; o tracer 06-02 compara diretamente a mesma fixture histórica
...
- [ ] `tests/editorial/discovery-outputs.test.ts` — 06-05 e 06-11, metadata/OG/schema/sitemap/RSS/LLM/escaping
- [ ] `tests/editorial/governance.test.ts` — 06-10-01/02, brief/fontes/revisores/approval/operação

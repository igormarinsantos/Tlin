          ...
          <table role="presentation" width="100%" max-width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#0c0d0d" style="max-width: 600px; width: 100%; background-color: #0c0d0d; border: 1px solid #27272a; border-radius: 24px;">
            <tr>
              <td style="padding: 40px 24px;">
                ...
                <!-- Main Title -->
                <h2 style="font-family: 'DM Sans', Arial, sans-serif; font-size: 24px; font-weight: 800; color: #ffffff; margin: 0 0 20px 0; line-height: 1.3;">
                  Olá, <span style="color: #38E3FF;">${name}</span>! Bem-vindo à Tlin 🚀
                </h2>
                
                <!-- Chat Message Cell (Surface Premium em Tabela Inviolável) -->
                <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 32px;">
                  <tr>
                    <td width="36" valign="top" style="padding-right: 12px; padding-top: 4px;">
                    ...
                    <td valign="top">
                      <!-- Tabela interna base do balão (Evita cor invertida no texto) -->
                      <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#18181b" style="background-color: #18181b; border: 1px solid #27272a; border-left: 4px solid #38E3FF; border-radius: 8px 20px 20px 20px;">
                        <tr>
                          <td style="padding: 16px 20px; font-family: 'DM Sans', Arial, sans-serif; font-size: 15px; line-height: 1.5; color: #f4f4f5; font-weight: 500; text-align: left;">
                ...
                <!-- Video Media Card (Sem Position Absolute, Layout em Linhas de Tabela) -->
                <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#18181b" style="margin-bottom: 32px; background-color: #18181b; border: 1px solid #27272a; border-radius: 16px; overflow: hidden;">
                  <tr>
                    <td align="center" style="line-height: 0; font-size: 0; padding: 0;">
                      <a href="https://tlin.cloud#demo" target="_blank" style="display: block;">
                        <img src="https://tlin.cloud/platform-preview.webp" alt="Plataforma Tlin" width="600" style="width: 100%; max-width: 600px; height: auto; display: block; border: 0;" />
                      </a>
                    </td>
                  </tr>
                  <tr>
                ...
                <!-- Bulletproof CTA Button (Célula Nativa Roxa com Texto Branco de Alto Contraste) -->
                <table role="presentation" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-bottom: 24px;">
                  <tr>

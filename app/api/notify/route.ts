...
function getWelcomeEmailHtml(name: string, planName: string) {
  ...
  return `
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#0c0d0d" style="background-color: #0c0d0d; background-image: linear-gradient(#0c0d0d, #0c0d0d); width: 100%;">
        ...
        <td align="center" style="padding: 20px 12px;">
          <div style="background-color: #0c0d0d; background-image: linear-gradient(#0c0d0d, #0c0d0d); font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; width: 100%; max-width: 600px; box-sizing: border-box; margin: 0 auto; padding: 40px 24px; border: none; border-radius: 24px;">
            ...
            <div style="text-align: center; margin-bottom: 32px;">
              <img src="https://tlin.cloud/logo-horizontal-email.png?v=final9" alt="Tlin" width="160" style="display: block; margin: 0 auto; max-width: 160px; height: auto;" />
            </div>
            
            <!-- Main Title com Cores Saturadas Imunes à Inversão do Gmail -->
            <h2 style="font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 800; color: #38E3FF; margin-top: 0; margin-bottom: 24px; line-height: 1.3; text-align: center;">
              Olá, ${name}! <br/>
              <span style="color: #B597FF;">Bem-vindo à Tlin 🚀</span>
            </h2>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 32px;">
              <tr>
                ...
                <td width="32" valign="top" style="padding-right: 10px; padding-top: 2px;">
                  <img src="https://tlin.cloud/tlin-mascote-email.png?v=final9" alt="Tlin" width="28" style="display: block; width: 28px; height: auto; background: transparent;" />
                </td>
                <!-- Chat Bubble com Texto Escuro Nativo de Alta Acessibilidade (Invertido Passivamente pelo Gmail no Celular) -->
                <td valign="top" align="left">
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse: separate; border-radius: 0px 20px 20px 20px; overflow: hidden;">
                    <tr>
                      <td bgcolor="#38E3FF" style="font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background: linear-gradient(90deg, #B597FF 0%, #38E3FF 100%); background-color: #38E3FF; color: #0c0d0d; font-weight: 700; font-size: 15px; line-height: 1.5; padding: 16px 20px; border-radius: 0px 20px 20px 20px; text-align: left;">
            ...
            <div style="margin-bottom: 32px; text-align: center; background-color: #18181b; border: 1px solid #27272a; border-radius: 16px; overflow: hidden;">
              <a href="https://tlin.cloud#demo" target="_blank" style="display: block; text-decoration: none; line-height: 0;">
                <img src="https://tlin.cloud/platform-preview-email.jpg?v=final9" alt="Demonstração da Plataforma Tlin" style="width: 100%; max-width: 600px; height: auto; display: block; margin: 0 auto; opacity: 0.95;" />
              </a>
      ...
      <p style="font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #a1a1aa; margin-bottom: 32px; text-align: center;">
